...
include(cmr_stlcache_get_download_params)


# TODO: make docs
function(cmr_stlcache_cmaker)
  ...
  cmr_stlcache_get_download_params(${lib_VERSION}
  ...
  if(COPY_STLCACHE_CMAKE_BUILD_SCRIPTS)
    ...
    execute_process(
      COMMAND ${CMAKE_COMMAND} -E copy_directory
        ${PROJECT_SOURCE_DIR}/cmake/modules/stlcache-${lib_VERSION}
        ${lib_SRC_DIR}/
    )
  endif()
